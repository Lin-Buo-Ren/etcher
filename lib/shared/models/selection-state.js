...
/**
 * @summary Get selected drives devices
 * @function
 * @public
 *
 * @returns {Object[]} selected drives devices
 *
 * @example
 * for (driveDevice of selectionState.getDrives()) {
 ...
 *
 * @example
 * const drive = selectionState.findDrive('/dev/sdb')
 */
exports.findDrive = (driveDevice) => {
  return _.find(exports.getDrives(), {
    device: driveDevice
  })
}

/**
 * @summary Get all selected drives
 * @function
 * @public
 *
 * @returns {Object[]} selected drives
 *
 * @example
